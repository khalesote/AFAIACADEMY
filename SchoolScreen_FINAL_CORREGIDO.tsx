  ...
  const cargarProgreso = async () => {
    try {
      ...
      const nivelesDesbloqueadosActualizados = {
        // A1 siempre está desbloqueado si el usuario está matriculado
        A1: true, // Siempre mostrar A1 habilitado
        // A2 solo se desbloquea si el usuario ha aprobado el A1
        A2: isAprobadoA1 === true,
        B1: unlockedLevels.includes('B1') || isMatriculadoB1B2,
        B2: unlockedLevels.includes('B2') || (isMatriculadoB1B2 && isAprobadoB1)
      };
      
      console.log('Estado de aprobación A1:', isAprobadoA1);
      console.log('Niveles desbloqueados actualizados:', nivelesDesbloqueadosActualizados);
          ...
          <View style={styles.standardButton}>
            ...
            <View style={{ flexDirection: 'column', alignItems: 'center' }}>
              <Text style={{ color: '#fff', fontSize: 18, fontWeight: 'bold', textAlign: 'center' }}>
                {(matriculadoA1A2 && matriculadoB1B2) ? '¡Matriculado en todos los niveles!' : 'Información de matrícula'}
              </Text>
            </View>
          </View>
